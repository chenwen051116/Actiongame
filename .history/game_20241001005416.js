var T = {
    W: 32,
    H: 32,
    P1: { x: 0, y: 0, color: 0xCD5C5C, health: 5, speed: 1 },
    P2: { x: 31, y: 31, color: 0x4169E1, health: 5, speed: 1 },
    obstacles: [],
    powerUps: [],
    projectiles: [],
    ...
    init: function() {
        ...
        this.placeObstacles();
        this.updateBoard();
        PS.statusText("P1: Arrows P2: WASD  Attack: Space/Enter");
    ...
    updateBoard: function() {
        ...
        for (let i = 0; i < this.projectiles.length; i++) {
            ...
            PS.color(proj.x, proj.y, 0xFF0000);  
        }
