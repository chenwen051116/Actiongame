...
var T = {
    ...
    init: function() {
        ...
        this.coinInterval = PS.timerStart(60, this.incrementCoins.bind(this)); // Coins increase over time
    },
...
PS.keyDown = function(key) {
    if (key >= 37 && key <= 40) {
        T.handleKeyPress(key, 2); // Arrow keys for player 2
    } else {
        T.handleKeyPress(key, 1); // WASD for player 1
    }
};
