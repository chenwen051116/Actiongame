var T = {
    ...
    P2: { x: 32, y: 7, color: 0x4169E1, health: 5, speed: 1 },
    obstacles: [],
    powerUps: [],
    projectiles: [],
    ...
    handleKeyPress: function(key) {
        ...
        if (key === 13) this.shootProjectile(this.P1, 1, 0);  // Player 1 shoots right
        ...
        if (key === PS.KEY_SPACE) this.shootProjectile(this.P2, -1, 0);  // Player 2 shoots left
    }
};
