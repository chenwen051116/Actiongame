var T = {
    ...
    startTimers: function() {
        ...
        this.powerUpTimer = PS.timerStart(900, this.generatePowerUp.bind(this));
    },
    ...
    knifeTimer: function(){
        PS.color(knifeX, knifeY, 0x303030);
        PS.timerStop(knifet);
    }
    ...
    knifeAttack: function(p) {
        let knifeX = p.x + p.fx;
        let knifeY = p.y + p.fy;
        let knifet = PS.timerStart(3,this.knifeTimer())
        PS.color(knifeX, knifeY, 0xFF0000);
    ...
    handleKey: function(key) {
        ...
        if (key === 39) this.knifeAttack(this.p1);
